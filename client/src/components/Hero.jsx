...
export default function Hero() {
  ...
  return (
    <div ref={containerRef} className="relative w-full" style={{ height: '300vh' }}>
      ...
      >
        {/* Background Luxury Villa Image (visible behind initial red curtain expansion) */}
        <div className="absolute inset-0 z-0">
          <img
            src="https://cdn.fame-estate.com/service1_23ad1a8002.webp"
            alt="Fame estate luxury background"
        ...
        <div ref={bottomBarRef} className="w-full flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-white/10 z-20 text-neutral-400 l2">
          <div>DUBAI & BANGKOK LUXURY PORTFOLIO</div>
        ...
        >
          {/* Scroll Image Sequence Frames (Images change first on scroll with sharp edges and no bottom text) */}
          <div className="absolute inset-0 z-0 flex items-center justify-center p-4 sm:p-12">
            {/* Image 1: Dubai Luxury Villa */}
            <div ref={img1Ref} className="absolute w-full max-w-4xl aspect-[16/9] rounded-none overflow-hidden shadow-2xl border border-black/30" style={{ opacity: 0 }}>
              <img src="https://cdn.fame-estate.com/service1_23ad1a8002.webp" alt="Property showcase 1" className="w-full h-full object-cover" />
            </div>

            {/* Image 2: Bangkok Penthouse */}
            <div ref={img2Ref} className="absolute w-full max-w-4xl aspect-[16/9] rounded-none overflow-hidden shadow-2xl border border-black/30" style={{ opacity: 0 }}>
              <img src="https://cdn.fame-estate.com/medium_4_3c487dd279.png" alt="Property showcase 2" className="w-full h-full object-cover" />
            </div>

            {/* Image 3: Exclusive Waterfront Estate */}
            <div ref={img3Ref} className="absolute w-full max-w-4xl aspect-[16/9] rounded-none overflow-hidden shadow-2xl border border-black/30" style={{ opacity: 0 }}>
              <img src="https://cdn.fame-estate.com/team1_6263c4b459.jpg" alt="Property showcase 3" className="w-full h-full object-cover" />
            </div>
          </div>
          ...
          <div ref={revealTextRef} className="relative z-10 text-center px-6 max-w-4xl" style={{ opacity: 0, color: '#000000', transformOrigin: 'center center' }}>
            <span className="l1 text-xs uppercase tracking-widest block mb-4" style={{ color: '#000000' }}>Exclusive Dubai & Bangkok</span>
            ...
            <p className="l1 text-xs max-w-md mx-auto mt-6 leading-relaxed" style={{ color: '#000000' }}>
              We sell real estate that evokes emotions and gives a new sense of self.
            </p>
          </div>
        </div>
